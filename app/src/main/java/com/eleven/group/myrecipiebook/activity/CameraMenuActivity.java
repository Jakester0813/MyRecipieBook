...
public class CameraMenuActivity extends Activity {
	...
	private Integer videoWidth = 3000;
	private Integer videoHeight = 2800;

	private Integer pictureWidth = 4200;
	private Integer pictureHeight = 3800;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnImgBrowse = (Button) findViewById(R.id.btnGridShow);
		...
		btnImg.setOnClickListener(new View.OnClickListener() {
									  ...
									  public void onClick(View view) {
										  Intent i = new Intent(CameraMenuActivity.this, Camera2Activity.class);
										  startActivity(i);
									  }
								  });
		btnVideoBrowse = (Button) findViewById(R.id.btnVideoBrowse);
	...
	private void showImgCount() {
		imgPath = Environment.getExternalStorageDirectory().getAbsolutePath()
				+ "/MyRecipes/img/" + String.valueOf(parentId) + "/";
	...
	public void showVideoCount() {
		videoPath = Environment.getExternalStorageDirectory().getAbsolutePath()
				+ "/MyRecipes/video/" + String.valueOf(parentId) + "/";
